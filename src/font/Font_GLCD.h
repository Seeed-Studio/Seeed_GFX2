/**
 * @file   Font_GLCD.h
 * @brief  GLCD font (Adafruit 5x7 pixel font) for Seeed_GFX v2.0
 *
 * This is Font 1 - the original Adafruit 5x7 pixel font.
 * Each character is 5 bytes (5 columns), 256 characters total.
 * Needs ~1280 bytes in FLASH.
 */

#ifndef SEEED_GFX_FONT_GLCD_H
#define SEEED_GFX_FONT_GLCD_H

#include <Arduino.h>

// Standard ASCII 5x7 font - 256 characters, 5 bytes each
// Adapted from Adafruit_GFX glcdfont.c
static const unsigned char glcd_font[] PROGMEM = {
    ...
    0x55, 0x00, 0x55, 0x00, 0x55, // 0xB0 25% block
    0xAA, 0x55, 0xAA, 0x55, 0xAA, // 0xB1 50% block
    0xFF, 0x55, 0xFF, 0x55, 0xFF, // 0xB2 75% block
