...
void setup() {
    Serial.begin(115200);
    if (!display.begin<Board_XIAO_ePaper_EE05, Config_Seeed_ePaper_4inch2_BW_SSD1683>()) { Serial.println(display.lastResult().message); return; }
    ...
    display.drawRightString("EE05 / SSD1683", w - 10, 16, 1);
