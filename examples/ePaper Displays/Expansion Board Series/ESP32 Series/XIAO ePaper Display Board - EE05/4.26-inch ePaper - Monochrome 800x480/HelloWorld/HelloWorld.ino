...
void setup() {
    Serial.begin(115200);
    if (!display.begin<Board_XIAO_ePaper_EE05, Config_Seeed_ePaper_4inch26_BW_SSD1677>()) { Serial.println(display.lastResult().message); return; }
    ...
    display.drawString("XIAO ePaper Driver Board - EE05", 48, 28);
