...
void setup() {
    Serial.begin(115200);
    if (!display.begin<Board_XIAO_ePaper_EE05, Config_Seeed_ePaper_2inch13_BWRY_JD79676>()) { Serial.println(display.lastResult().message); return; }
    ...
    display.drawRightString("EE05 / 4-color", w - 6, 8, 1);
