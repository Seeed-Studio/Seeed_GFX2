/**
 * Panel: 2.9-inch ePaper - Monochrome 128x296
...
void setup() {
    Serial.begin(115200);
    if (!display.begin<Board_XIAO_ePaper_EE04, Config_Seeed_ePaper_2inch9_BW_SSD1680>()) {
    ...
    display.drawBitmap(0, 0, gImage_2inch9, 128, 296, TFT_BLACK, TFT_WHITE);
