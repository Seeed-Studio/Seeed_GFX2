 ...
 * Board: Board_XIAO_ePaper_EE04 (template API - no registered product for this board).
...
void setup() {
    Serial.begin(115200);
    if (!display.begin<Board_XIAO_ePaper_EE04, Config_Seeed_ePaper_7inch5_BW_UC8179>()) { Serial.println(display.lastResult().message); return; }
