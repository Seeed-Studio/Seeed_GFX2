...
void setup() {
    Serial.begin(115200);
    if (!display.begin<Board_XIAO_ePaper_EN05, Config_Seeed_ePaper_1inch54_BW_SSD1681>()) { Serial.println(display.lastResult().message); return; }
    ...
    display.drawCentreString("EN05 / SSD1681", w / 2, 32, 1);
