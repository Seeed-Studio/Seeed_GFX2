 ...
 * Board: Board_XIAO_ePaper_EN05 (template API - no registered product for this board).
 *
...
void setup() {
    Serial.begin(115200);
    if (!display.begin<Board_XIAO_ePaper_EN05, Config_Seeed_ePaper_2inch9_BWRY_JD79667>()) {
    ...
    display.drawRightString("EN05 / 4-color", w - 8, 10, 1);
