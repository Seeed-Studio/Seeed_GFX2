 ...
 * Panel: 7.5-inch tri-color 800x480 (B/W compatibility path)
 * Board: XIAO ePaper Display Board EN04
 *
 ...
 *
 * Note: Seeed_GFX2 currently exposes the UC8179 monochrome transfer path for
 * this panel. This example intentionally demonstrates only black and white;
 * it does not falsely render TFT_RED as if the red plane were supported.
 */
...
void setup() {
    ...
    Board_XIAO_EPaper_EN04::configureBus(bus);
