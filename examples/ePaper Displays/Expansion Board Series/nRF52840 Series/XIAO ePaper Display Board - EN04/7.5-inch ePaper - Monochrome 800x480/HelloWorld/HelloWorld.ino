...
void setup() {
    Serial.begin(115200);
    if (!display.begin<Board_XIAO_ePaper_EN04, Config_Seeed_ePaper_7inch5_BW_UC8179>()) { Serial.println(display.lastResult().message); return; }
    ...
    display.drawString("XIAO ePaper Display Board - EN04", 36, 28);
