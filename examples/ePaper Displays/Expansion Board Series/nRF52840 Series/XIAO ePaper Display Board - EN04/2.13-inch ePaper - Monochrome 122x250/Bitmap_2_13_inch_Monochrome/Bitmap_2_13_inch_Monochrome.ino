 ...
 * Board: EN04 (ePaper Driver Board for Seeed Studio XIAO nRF52840)
 * Demo:  Display an embedded bitmap image.
 *
 * This example was adapted from the EE04 variant for the EN04 board.
...
void setup() {
    Serial.begin(115200);
    if (!display.begin<Board_XIAO_ePaper_EN04, Config_Seeed_ePaper_2inch13_BW_SSD1680>()) {
