 ...
 * Board: EN04 (template API - no registered product for this board).
...
void setup() {
    Serial.begin(115200);
    if (!display.begin<Board_XIAO_ePaper_EN04, Config_Seeed_ePaper_4inch26_BW_SSD1677>()) { Serial.println(display.lastResult().message); return; }
    ...
    display.drawString("XIAO ePaper Driver Board - EN04", 48, 28);
