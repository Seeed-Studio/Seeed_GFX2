/**
 * Panel: 1.54-inch ePaper - Monochrome 200x200
...
void setup() {
    Serial.begin(115200);
    if (!display.begin<Board_XIAO_ePaper_EN04, Config_Seeed_ePaper_1inch54_BW_SSD1681>()) {
    ...
    display.drawBitmap(0, 0, gImage_1inch54, 200, 200, TFT_BLACK, TFT_WHITE);
