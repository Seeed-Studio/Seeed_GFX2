 ...
 *
 * The 2.13" rigid glass is physically landscape (250x122 long edge horizontal).
 * The SSD1680 RAM is portrait (128x250), so we rotate the frame buffer into a
 * 250x122 landscape viewport with setRotation(3). Font output range (title
 * textSize 2 @ (6,4), subtitle @ (w-6,8), divider y=26, banner @ (6,h-18))
