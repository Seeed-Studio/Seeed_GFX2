/**
 * Panel: 5.83-inch ePaper - Monochrome 648x480
...
void setup() {
    Serial.begin(115200);
    if (!display.begin<Board_XIAO_ePaper_Breakout, Config_Seeed_ePaper_5inch83_BW_UC8179>()) {
    ...
    display.drawBitmap(0, 0, gImage_5inch83, 648, 480, TFT_BLACK, TFT_WHITE);
