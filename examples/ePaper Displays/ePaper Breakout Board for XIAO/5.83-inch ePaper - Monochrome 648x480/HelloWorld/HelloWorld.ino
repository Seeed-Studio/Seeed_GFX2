...
void setup() {
    Serial.begin(115200);
    if (!display.begin<Board_XIAO_ePaper_Breakout, Config_Seeed_ePaper_5inch83_BW_UC8179>()) { Serial.println(display.lastResult().message); return; }
    ...
    display.drawRightString("UC8179", w - 12, 18, 1);
