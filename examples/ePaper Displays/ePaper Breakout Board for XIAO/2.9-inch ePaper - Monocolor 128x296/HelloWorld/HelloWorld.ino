 ...
 * 296 x 128 landscape viewport with setRotation(3). Text then reads along
 * the long edge instead of sideways.
 */
#include <Seeed_GFX.h>
...
void setup() {
    Serial.begin(115200);
    if (!display.begin<Board_XIAO_ePaper_Breakout, Config_Seeed_ePaper_2inch9_BW_SSD1680>()) {
