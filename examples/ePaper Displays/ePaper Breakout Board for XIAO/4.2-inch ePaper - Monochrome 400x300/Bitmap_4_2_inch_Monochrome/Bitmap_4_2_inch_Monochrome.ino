/**
 * Panel: 4.2-inch ePaper - Monochrome 400x300
...
void setup() {
    Serial.begin(115200);
    if (!display.begin<Board_XIAO_ePaper_Breakout, Config_Seeed_ePaper_4inch2_BW_SSD1683>()) {
    ...
    display.drawBitmap(0, 0, gImage_4inch2, 400, 300, TFT_BLACK, TFT_WHITE);
