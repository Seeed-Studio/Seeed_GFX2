/**
 * Panel: 7.5-inch ePaper - Monochrome 800x480
...
void setup() {
    Serial.begin(115200);
    if (!display.begin<Board_XIAO_ePaper_Breakout, Config_Seeed_ePaper_7inch5_BW_UC8179>()) {
    ...
    display.drawBitmap(0, 0, gImage_7inch5, 800, 480, TFT_BLACK, TFT_WHITE);
