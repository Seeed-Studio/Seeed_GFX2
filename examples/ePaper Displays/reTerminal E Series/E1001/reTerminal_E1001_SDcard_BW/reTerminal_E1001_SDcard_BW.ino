...
void setup() {
  ...
  // The library board config starts the display and SD slot on the same HSPI
  // instance with GPIO8 MISO already routed. Do not end()/begin() that bus:
  // doing so invalidates the display driver's SPI ownership.
  Bus_SPI& displayBus =
